package com.pedroid.qrcodecompose.androidapp.features.history.navigation.expand
...
@Serializable
data class ExpandHistoryQRCodeRoute(
    val label: String,
    val code: String,
...
fun NavController.navigateToExpandHistoryQRCode(
